...
const Banner = ({ movie }) => {
  return (
    <div className="h-[20vh] md:h-[30vh] relative drop-shadow-[0_0_80px_rgba(255,255,255,0.15)]">
      <img src={baseImgUrl + movie.backdrop_path} alt="banner" className="size-full rounded-sm object-cover" />

      <div className="bg-[#00000069] absolute inset-0 grid place-items-center p-3">
