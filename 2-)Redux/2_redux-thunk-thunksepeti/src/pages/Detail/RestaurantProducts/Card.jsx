...
import { addItem, updateItem } from "../../../redux/actions/basketActions";
    ...
    <div className="grid grid-cols-[1fr_115px] gap-3 shadow  p-3 rounded-lg hover:bg-red-100 cursor-pointer transition duration-300 hover:scale-[1.02]">
      ...
      <div className="relative">
        ...
        <button
          type="button"
          onClick={handleAdd}
          className="absolute end-2 bottom-2 bg-white rounded-full size-8 grid place-items-center font-bold"
        >
